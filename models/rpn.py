...
#FG_FILE = "LVIS-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml"
...
def get_class_agnostic_config():
    ...
    #cfg.MODEL.WEIGHTS = r'output/model_0003999.pth'
    #cfg.MODEL.WEIGHTS = r'/scratch/users/zzweng/output/coco/model_0067999.pth'
...
class ProposalNetwork(nn.Module):
    ...
    def load(self, checkpoints_path, i):
        try:
